...
const LINKS = {
  Protocol:   ['x402 Standard', 'FlowPayStream', 'RWA Module', 'Ethereum Sepolia'],
    ...
    <footer className="w-full bg-surface-950 border-t border-surface-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-surface-800 border border-surface-700 text-surface-400">Built on Ethereum</span>
            </div>
          </div>
        ...
        <div className="border-t border-surface-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-surface-600">© {new Date().getFullYear()} Stream Engine. MIT License. Built on Ethereum.</p>
