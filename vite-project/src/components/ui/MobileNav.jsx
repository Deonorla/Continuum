          ...
          return (
            <Link
              ...
              className={`
                ...
                ${activeTab === tab.id
                  ? 'bg-stella-500/20 text-stella-300'
            ...
            >
              ...
              {activeTab === tab.id && (
                <div className="absolute bottom-1 w-1 h-1 rounded-full bg-stella-400" />
              )}
            </Link>
          );
        })}
  ...
  return (
    <div className="fixed top-20 left-1/2 -translate-x-1/2 z-50 animate-slide-down">
      <div className="flex items-center gap-2 px-4 py-2 rounded-full glass">
        <svg className="w-4 h-4 animate-spin text-stella-400" viewBox="0 0 24 24" fill="none">
