  ...
  return (
    <div className="flex items-center justify-between py-2.5 border-b border-surface-700 last:border-b-0">
      ...
      <button
        ...
        onClick={() => setOn(!on)}
        className={`relative w-10 h-5 rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-stella-500/50 ${on ? 'bg-success-500' : 'bg-surface-600'}`}
      >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-stella-400 text-sm font-semibold uppercase tracking-widest font-mono">Safety & Compliance</p>
          ...
          <div className="bg-surface-800 rounded-2xl border border-surface-700 p-6 shadow-card font-mono">
            ...
            <div className="mt-5 pt-4 border-t border-surface-700 space-y-2">
              ...
              <input id="budget-cap" type="number" defaultValue="50" className="w-full bg-surface-900 border border-surface-700 rounded-lg px-3 py-2 text-stella-400 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-stella-500/50 hover:border-surface-600 transition-colors duration-200" aria-label="Agent daily budget cap in USDC" />
            </div>
