import { Building2, Car, Cpu, UploadCloud, Info, ShieldCheck, FileText, Globe } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="col-span-1 lg:col-span-3 space-y-6">
          <div className="bg-slate-50 p-6 rounded-3xl space-y-8 border border-slate-100">
            {[
              { label: 'Indexed Assets', value: '1,248', sub: '+14% this month', subColor: 'text-secondary', color: 'text-primary' },
              ...
              <div key={i}>
                ...
                <div className="flex items-center gap-1 mt-1">
                  {s.pulse && <span className="w-2 h-2 rounded-full bg-secondary animate-pulse"></span>}
        ...
        <div className="col-span-1 lg:col-span-9">
          <div className="bg-white rounded-[2rem] p-8 lg:p-12 shadow-sm border border-slate-100">
            <div className="flex gap-8 mb-10 border-b border-slate-100">
              <button className="pb-4 font-label text-sm uppercase tracking-[0.15em] border-b-2 border-primary text-primary font-bold">Minting</button>
              <button className="pb-4 font-label text-sm uppercase tracking-[0.15em] text-slate-400 hover:text-primary transition-colors">Verify</button>
              <button className="pb-4 font-label text-sm uppercase tracking-[0.15em] text-slate-400 hover:text-primary transition-colors">Rent Assets</button>
              <button className="pb-4 font-label text-sm uppercase tracking-[0.15em] text-slate-400 hover:text-primary transition-colors">My Portfolio</button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <form className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <button type="button" className="p-4 rounded-2xl bg-blue-50 text-primary border border-blue-200 flex flex-col items-center gap-2">
                        <Building2 size={20} /><span className="text-[10px] font-bold uppercase">Real Estate</span>
                      </button>
                      <button type="button" className="p-4 rounded-2xl bg-slate-50 hover:bg-slate-100 transition-colors flex flex-col items-center gap-2">
                        <Car size={20} className="text-slate-400" /><span className="text-[10px] font-bold uppercase text-slate-400">Vehicle</span>
                      </button>
                      <button type="button" className="p-4 rounded-2xl bg-slate-50 hover:bg-slate-100 transition-colors flex flex-col items-center gap-2">
                        <Cpu size={20} className="text-slate-400" /><span className="text-[10px] font-bold uppercase text-slate-400">Equipment</span>
                      </button>
                    </div>
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div className="relative p-8 rounded-[2.5rem] bg-gradient-to-b from-slate-50 to-white border border-slate-100 overflow-hidden">
                  <div className="absolute -top-24 -right-24 w-64 h-64 bg-teal-200 blur-[80px] rounded-full opacity-30"></div>
                  <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-blue-200 blur-[80px] rounded-full opacity-30"></div>
                  <div className="relative z-10 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                      {[
                        { label: 'Schema Type', value: 'Physical Real Estate v2.1' },
