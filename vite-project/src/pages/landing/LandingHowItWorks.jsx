...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'DOT locked in FlowPayStream contract on Polkadot → streamed per-second to recipient → cancel anytime for instant refund.',
    ...
    <section id="protocol" className="w-full bg-surface-950 py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-3 mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-white">One Protocol. Polkadot. Infinite Agents.</h2>
        </div>
