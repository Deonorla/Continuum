...
contract FlowPayAssetAttestationRegistry is Owned {
    ...
    modifier onlyController() {
        require(msg.sender == controller, "FlowPayAssetAttestationRegistry: caller is not controller");
        _;
    }
    ...
    function registerAttestation(
        ...
        require(tokenId != 0, "FlowPayAssetAttestationRegistry: tokenId is zero");
        require(attestor != address(0), "FlowPayAssetAttestationRegistry: attestor is zero");
    ...
    function revokeAttestation(uint256 attestationId, string calldata reason) external onlyController {
        ...
        require(attestation.tokenId != 0, "FlowPayAssetAttestationRegistry: attestation not found");
        require(!attestation.revoked, "FlowPayAssetAttestationRegistry: attestation already revoked");
