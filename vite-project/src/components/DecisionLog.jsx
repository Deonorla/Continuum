...
const TimelineEntry = ({ log, isLast, onExpand, isExpanded }) => {
    ...
    return (
        ...
        ${isStream ? 'bg-stella-500/20 border-2 border-stella-500' : 'bg-success-500/20 border-2 border-success-500'}
        ${log.isNew ? 'animate-pulse' : ''}
      `}>
                {isStream ? <Waves className="w-3 h-3 text-stella-400" /> : <Zap className="w-3 h-3 text-success-400" />}
            </div>
          ...
          ${isStream ? 'glass-primary border-stella-500/20' : 'glass border-success-500/20'}
        ...
        `}
            ...
            >
                ...
                <div className="flex items-center justify-between mb-2">
                    <span className={`font-bold text-sm uppercase tracking-wide flex items-center gap-1 ${isStream ? 'text-stella-400' : 'text-success-400'}`}>
                    ...
                    <div className="mt-4 pt-4 border-t border-white/10 animate-slide-down space-y-3">
                        ...
                        <div className="text-sm">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div className={`p-3 rounded-lg ${isStream ? 'bg-stella-500/10' : 'bg-white/5'}`}>
                                    <div className="text-xs text-white/50">Streaming Cost</div>
                                    <div className={`font-mono font-bold ${isStream ? 'text-stella-300' : 'text-white/70'}`}>
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="space-y-2">
                <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-stella-500" />
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="p-4 rounded-xl glass text-center">
                <div className="text-2xl font-bold text-stella-400">{stats.streamCount}</div>
