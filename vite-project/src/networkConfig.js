...
export const ACTIVE_NETWORK = {
  key: 'stellar-testnet',
  kind: 'stellar',
  name: env.VITE_STELLA_NETWORK_NAME || 'Stellar Testnet',
  chainId: Number(env.VITE_STELLA_CHAIN_ID || 0),
  rpcUrl: env.VITE_STELLA_RPC_URL || 'https://soroban-testnet.stellar.org',
  ...
  explorerUrl: env.VITE_STELLA_BLOCK_EXPLORER_URL || 'https://stellar.expert/explorer/testnet',
