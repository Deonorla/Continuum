...
export const paymentTokenAddress =
  env.VITE_STELLA_PAYMENT_TOKEN_ADDRESS
  || 'stellar:usdc-sac';

export const paymentTokenSymbol = env.VITE_STELLA_PAYMENT_TOKEN_SYMBOL || 'USDC';
export const paymentTokenDisplayName =
  env.VITE_STELLA_PAYMENT_TOKEN_NAME
  || 'USDC on Stellar';
export const paymentTokenDecimals = Number(
  env.VITE_STELLA_PAYMENT_TOKEN_DECIMALS || 7,
);
export const paymentAssetCode = env.VITE_STELLAR_PAYMENT_ASSET_CODE || env.VITE_STELLA_PAYMENT_TOKEN_SYMBOL || 'USDC';
