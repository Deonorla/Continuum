  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        // Stella Brand Gradients
        'stella-gradient': 'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 50%, #a855f7 100%)',
        'stella-subtle': 'linear-gradient(135deg, rgba(59,130,246,0.1) 0%, rgba(168,85,247,0.1) 100%)',
